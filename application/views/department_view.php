<?php $this->load->view('header') ?> 
    ...
    <main class="app-content" ng-controller="department">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i> ข้อมูลกลุ่มงาน</h1>
         <!-- <p>Start a beautiful journey here</p>-->
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="<?php echo base_url('index.php/department');   ?>">ข้อมูลกลุ่มงาน</a></li>
        </ul>
      </div>
      <div class="row" >
        <div class="col-md-12">
          ...
          <div class="tile">
            ...
            <table class="table table-bordered">
              ...
              <tbody ng-repeat="d in department">
                <tr>
                  <td>{{$index+1}}</td>
                  <td>{{d.department_name}}</td>
                  <td>{{d.head_department}}</td>
                  <td> </td>
                  <td>
